    ...
    <div class="Academic-Details">
        ...
        <form action="" method="post">
            <div class="form-container">
                ...
                <input type="text" id="reg_number" name="reg_number" spellcheck="false" placeholder="Enter Your Registration Number" value="<?php echo isset($_SESSION['regNumber']) ? $_SESSION['regNumber'] : ''; ?>" required>
            ...
            <div>
                <button type="submit" name="submit" id="apply_btn">Apply</button>
            </div>
        </form>
    </div>    
...
if (isset($_POST["submit"])) {
    ...
    $devision_name = ""; // You need to get this value from your form or another source

    // Checking if the registration number already exists
    ...
    if ($result1->num_rows > 0) {
        ...
        // Inserting new application details into the database
        $sql2 = "INSERT INTO `studentapply`(`Registration_number`, `course_name`, `semester`,
        `academic_year`, `index_number`, `devision_name`, `subject`) 
        VALUES ('$reg_number', '$course_name', '$semester', '$academic_year', '$index_no', '$devision_name', '$Subjects')";
